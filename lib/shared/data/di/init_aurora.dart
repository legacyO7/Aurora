...
import 'package:aurora/shared/data/io/file_manager/file_manager.dart';
import 'package:aurora/shared/data/io/file_manager/file_manager_impl.dart';
import 'package:aurora/shared/data/io/service_manager/service_manager.dart';
import 'package:aurora/shared/data/io/service_manager/service_manager_impl.dart';
import 'package:aurora/shared/terminal/data/source/terminal_source.dart';
import 'package:aurora/shared/terminal/data/source/terminal_source_impl.dart';
...
import 'package:aurora/shared/terminal/domain/repository/terminal_repo.dart';
import 'package:aurora/shared/terminal/domain/repository/terminal_repo_impl.dart';
...
class InitAurora with GlobalMixin {
  ...
  Future initDI() async {
    ...
    sl.registerLazySingleton<DisablerRepo>(() => DisablerRepoImpl(sl(), sl(),sl(),sl()));
