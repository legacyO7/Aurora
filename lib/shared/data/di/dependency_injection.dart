...
class DependencyInjection{
  static Future initDI() async {
    ...
    sl.registerLazySingleton<KeyboardSettingsFaustusRepoImpl>(() => KeyboardSettingsFaustusRepoImpl(sl(), sl()));
    sl.registerLazySingleton<KeyboardSettingsMainlineRepoImpl>(() => KeyboardSettingsMainlineRepoImpl(sl(), sl()));
